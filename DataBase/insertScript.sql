...
INSERT INTO thread (thread_id, forum_id, title, text)
VALUES
('1', '1','Does anyone know how to start Redis?','I m trying to connect to Redis, but dont know how to start'),
('2', '2','Does anyone MongoDB?',' I know about MongoDB'),
('3', '3','Does anyone know AWS?','Yes, Its Amazon Web Services');
